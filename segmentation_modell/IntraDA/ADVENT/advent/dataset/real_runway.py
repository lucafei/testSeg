...
DEFAULT_INFO_PATH = project_root / 'advent/dataset/realrunway_list/info.json'


class RealRunwayDataSet(BaseDataset):
    def __init__(self, root, list_path, set='val',
        ...
        self.class_names = ['sky','forest','ground','runway']
        """
...
"""
    ...
    def get_metadata(self, name):
        ...
        label_file = self.root/'labels'/self.set/label_name
