...
from advent.model.deeplabv3 import get_deeplab_v3
...
def main():
    ...
    elif cfg.TRAIN.MODEL == 'DeepLabv3':
        #checkpoint = torch.load(cfg.TRAIN.RESTORE_FROM)
        model = get_deeplab_v3('mobilenet')
    ...
    # DATALOADERS
    source_dataset = SimRunwayDataSet(root=cfg.DATA_DIRECTORY_SOURCE,
    ...
    target_dataset = RealRunwayDataSet(root=cfg.DATA_DIRECTORY_TARGET,
