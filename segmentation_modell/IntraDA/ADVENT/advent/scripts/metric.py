...
# --------------------------------------------------------
import sys
sys.path.append('C:/semseg/IntraDA/ADVENT')
import pdb
...
def main(config_file, exp_suffix, dataroot, expname, list):
    # LOAD ARGS
    ...
    #cfg.EXP_NAME = 'RealRunwayEasy2RealRunwayHard_DeepLabv2_AdvEnt_4class_18_01'
    cfg.EXP_NAME = expname
    ...
    # dataloaders
    #pdb.set_trace()
    test_dataset = RealRunwayDataSet(dataroot,
                                     list_path=list+'/{}.txt',
...
if __name__ == '__main__':
    ...
    print(args)
    main(args.cfg, args.exp_suffix, args.data_root, args.exp_name, args.list_path)
