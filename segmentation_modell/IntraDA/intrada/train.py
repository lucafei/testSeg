...
from advent.dataset.real_runway import RealRunwayDataSet as RealRunwayDataSet_hard
from cityscapes import CityscapesDataSet as CityscapesDataSet_easy
from realrunway import RealRunwayDataSet as RealRunwayDataSet_easy
...
def main():
    ...
    # DATALOADERS
    # pdb.set_trace()
    easy_dataset = RealRunwayDataSet_easy(root=cfg.DATA_DIRECTORY_SOURCE,
    ...
    # pdb.set_trace()
    hard_dataset = RealRunwayDataSet_hard(root=cfg.DATA_DIRECTORY_TARGET,
